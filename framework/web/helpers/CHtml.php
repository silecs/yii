...
class CHtml
{
	...
	/**
	 * @var string|callable the generator used in the {@link CHtml::modelName()} method.
	 * @since 1.1.14
	 */
...
EOD;
	 ...
	 * generator.
	 *
	 * @param string|callable|null $converter the new generator, the model or class name will be passed to the this callback
