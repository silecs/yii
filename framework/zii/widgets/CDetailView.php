...
class CDetailView extends CWidget
{
	...
	/**
	 * @var null|false|string the URL of the CSS file used by this detail view. Defaults to null, meaning using the integrated
	...
	public function run()
	{
		...
		foreach($this->attributes as $attribute)
		{
			...
			if(isset($attribute['value']))
				$value=!is_string($attribute['value']) && is_callable($attribute['value']) ? call_user_func($attribute['value'],$this->data) : $attribute['value'];
			elseif(isset($attribute['name']))
